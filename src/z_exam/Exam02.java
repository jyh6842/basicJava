...
/*		[2-4] 다음 중 기본형(primitive type)이 아닌 것은? b (앞글자가 대문자면 클래스 이름)
				a. int
				b. Byte
				c. double
				d. boolean
		...
		System.out.println('J' + “ava”) → ( Java) (String 타입은 다른 것들을 자신과 같은 문자열로 다 바꿈)
		System.out.println(true + null)→ (오류 ) (boolean 타입과 참조형 타입은 연산이 불가능) (boolean은 다른 타입들과 연산이 불가능)*/
...
/*		[2-9] 다음 중 형변환을 생략할 수 있는 것은? (모두 고르시오) d e (표현 범위로 따지는 거임) char은 음수를 표현할 수 없음 -> 형변환 생략 안됨
				byte b = 10;
				char ch = 'A';
				int i = 100;
				long l = 1000L;
...
/*		[2-11] 다음중 변수를 잘못 초기화 한 것은? (모두 고르시오) a b c d 
				...
				b. char c = ''; (공백 ㄴㄴ)
				c. char answer = 'no';
				d. float f = 3.14 (f 붙여야함 안 붙이면 double 타입)
				e. double d = 1.4e3f;
*/
		
/*		[2-13] 다음 중 타입과 기본값이 잘못 연결된 것은? (모두 고르시오) c f
				a. boolean - false
				b. char - '\u0000'
				c. float - 0.0 (0.0f)
				d. int - 0
